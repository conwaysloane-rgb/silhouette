      ...
      <div className="px-4 pt-5 space-y-5">
        ...
        {listing.seller && (
          <div className="rounded-2xl border border-neutral-100 p-4">
            <p className="text-xs font-semibold text-neutral-400 uppercase tracking-wide mb-3">Listed by</p>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-neutral-100 overflow-hidden flex-shrink-0 flex items-center justify-center text-neutral-400 font-semibold">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-neutral-900">{listing.seller.full_name}</p>
                ...
                {avgRating && (
                  <p className="text-xs text-neutral-500 mt-0.5">★ {avgRating} ({reviews?.length} review{reviews?.length !== 1 ? 's' : ''})</p>
                )}
              </div>
            </div>
            {listing.seller.bio && (
              <p className="text-sm text-neutral-600 mt-3">{listing.seller.bio}</p>
            )}
          </div>
        )}
      </div>
