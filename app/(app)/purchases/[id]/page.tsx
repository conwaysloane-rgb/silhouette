...
export default async function PurchaseDetailPage({
  ...
  return (
    <div className="px-4 pt-6 pb-10">
      ...
      {/* Chat button — always visible while pending */}
      {purchase.status === 'pending' && (
        <Link
          href={`/purchases/${purchase.id}/chat`}
          className="flex items-center justify-center gap-2 w-full border border-neutral-200 py-3 text-[11px] font-medium uppercase tracking-widest text-neutral-600 hover:border-neutral-900 hover:text-neutral-900 transition-colors mb-3"
        >
